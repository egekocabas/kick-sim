...
export function ActivityPage() {
  ...
  const query = useQuery({
    ...
    queryFn: async () => successful<{ items: Activity[] | null }>(await listRuns({ limit: 100, offset: 0 })).items ?? [],
  });
  return (
